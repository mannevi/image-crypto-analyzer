      ...
      <div style={S.root}>
        ...
        <div style={S.wrap}>
          ...
          <div style={S.footer}>
            ...
            <a href={`${window.location.origin.includes('localhost') ? 'https://image-crypto-analyzer.vercel.app' : window.location.origin}/public/certificate/${cert.certificateId}`} style={S.lnk}>
